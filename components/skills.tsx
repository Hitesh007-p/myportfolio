...
const flutterSkills: Skill[] = [
  ...
  },
  {
    ...
    proficiency: 92,
    subSkills: ["SQLite", "Hive", "Firebase Realtime Database", "REST & GraphQL APIs"],
  },
  {
    name: "Authentication",
    ...
    proficiency: 87,
    subSkills: ["Firebase Auth", "OAuth", "Social Login (Google, Facebook, Apple)", "Custom Auth Solutions"],
  },
  {
  ...
  },
  {
    ...
    proficiency: 93,
    subSkills: ["Google Play Store", "Apple App Store", "CI/CD", "App Size Optimization"],
  },
  {
